<nav x-data="{ open: false }" class="bg-blue border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- new  --}}
            <x-jet-responsive-nav-link href="{{ route('pages.virtualAssistant') }}" :active="request()->routeIs('pages.virtualAssistant')">
            ...
            {{-- new --}}
            <x-jet-responsive-nav-link href="{{ route('pages.volunteer') }}" :active="request()->routeIs('pages.volunteer')">
            ...
            {{-- new --}}
            <x-jet-responsive-nav-link href="{{ route('pages.careTips') }}" :active="request()->routeIs('pages.careTips')">
                {{ __(' 💊 Animal Care Tips') }}
            </x-jet-responsive-nav-link>
